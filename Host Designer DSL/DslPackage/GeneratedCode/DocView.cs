...
namespace Microsoft.Practices.ServiceFactory.HostDesigner
{
	...
	/// </summary>
	internal abstract class HostDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new HostDesignerDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			HostDesignerDocDataBase docData = this.DocData as HostDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for HostDesignerDocViewBase should be an HostDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.HostDesignerDiagramMenu;
			}
		}
