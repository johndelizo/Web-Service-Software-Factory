...
namespace Microsoft.Practices.ServiceFactory.HostDesigner
{
	...
	internal abstract class HostDesignerCommandSetBase : DslShell::CommandSet
	{
		...
		internal virtual void OnMenuValidateModel(object sender, System.EventArgs e)
		{
			...
			{
				this.CurrentHostDesignerDocData.ValidationController.Validate(this.CurrentHostDesignerDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class HostDesignerClipboardCommandSet : HostDesignerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new HostDesignerClipboardCommandSet.
		/// </summary>
		public HostDesignerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class HostDesignerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new HostDesignerClipboardCommandSetBase.
		/// </summary>
		protected HostDesignerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
