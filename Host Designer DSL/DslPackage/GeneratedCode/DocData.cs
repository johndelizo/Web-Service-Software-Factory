...
namespace Microsoft.Practices.ServiceFactory.HostDesigner
{
	...
	/// </summary>
	internal abstract partial class HostDesignerDocDataBase : DslShell::ModelingDocData
	{
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected override void Save(string fileName)
		{
			...
			{
				global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDiagram diagram = diagrams[0] as global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerModel modelRoot = this.RootElement as global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Microsoft.Practices.ServiceFactory.HostDesigner.HostDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
