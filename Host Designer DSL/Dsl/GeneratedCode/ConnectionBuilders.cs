...
namespace Microsoft.Practices.ServiceFactory.HostDesigner
{
	...
	/// </summary>
	internal partial class HostApplicationCreateAction : DslDiagrams::CreateAction
	{
		/// <summary>
		/// Constructs a new HostApplicationCreateAction for the given Diagram.
		/// </summary>
		public HostApplicationCreateAction(DslDiagrams::Diagram diagram): base(diagram)
		{
		}
	}
	...
	/// Handles creation of an element through its ElementTool.
	/// </summary>
	internal partial class EndpointCreateAction : DslDiagrams::CreateAction
	{
		/// <summary>
		/// Constructs a new EndpointCreateAction for the given Diagram.
		/// </summary>
		public EndpointCreateAction(DslDiagrams::Diagram diagram): base(diagram)
		{
		}
	}
	...
	/// Handles creation of an element through its ElementTool.
	/// </summary>
	internal partial class ClientApplicationCreateAction : DslDiagrams::CreateAction
	{
		/// <summary>
		/// Constructs a new ClientApplicationCreateAction for the given Diagram.
		/// </summary>
		public ClientApplicationCreateAction(DslDiagrams::Diagram diagram): base(diagram)
		{
		}
	}
	...
	/// Handles creation of an element through its ElementTool.
	/// </summary>
	internal partial class ProxyCreateAction : DslDiagrams::CreateAction
	{
		/// <summary>
		/// Constructs a new ProxyCreateAction for the given Diagram.
		/// </summary>
		public ProxyCreateAction(DslDiagrams::Diagram diagram): base(diagram)
		{
		}
	}
	...
	/// </summary>
	internal partial class ProxyEndpointConnectionToolConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new ProxyEndpointConnectionToolConnectAction for the given Diagram.
		/// </summary>
		public ProxyEndpointConnectionToolConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the ProxyEndpointConnectionToolConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new ProxyEndpointConnectionToolConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class ProxyEndpointConnectionToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the ProxyEndpointConnectionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected ProxyEndpointConnectionToolConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder ProxyReferencesEndpointBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return ProxyReferencesEndpointBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return ProxyReferencesEndpointBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				ProxyReferencesEndpointBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class ProxyEndpointConnectionToolConnectionType : ProxyEndpointConnectionToolConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the ProxyEndpointConnectionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			public ProxyEndpointConnectionToolConnectionType() : base() {}
		}
	}
}
