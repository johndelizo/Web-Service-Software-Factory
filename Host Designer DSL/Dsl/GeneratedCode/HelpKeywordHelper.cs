...
namespace Microsoft.Practices.ServiceFactory.HostDesigner
{
	...
	/// </remarks>
	public partial class HostDesignerHelpKeywordHelper : HostDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new HostDesignerHelpKeywordHelper.
		/// </summary>
		protected HostDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the HostDesignerHelpKeywordHelper.
		/// </summary>
		public static HostDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class HostDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new HostDesignerHelpKeywordHelperBase.
		/// </summary>
		protected HostDesignerHelpKeywordHelperBase()
			: base() { }
