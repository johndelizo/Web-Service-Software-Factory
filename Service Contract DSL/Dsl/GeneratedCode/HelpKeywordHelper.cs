...
namespace Microsoft.Practices.ServiceFactory.ServiceContracts
{
	...
	/// </remarks>
	public partial class ServiceContractDslHelpKeywordHelper : ServiceContractDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ServiceContractDslHelpKeywordHelper.
		/// </summary>
		protected ServiceContractDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ServiceContractDslHelpKeywordHelper.
		/// </summary>
		public static ServiceContractDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ServiceContractDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ServiceContractDslHelpKeywordHelperBase.
		/// </summary>
		protected ServiceContractDslHelpKeywordHelperBase()
			: base() { }
