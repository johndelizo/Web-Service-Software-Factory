...
namespace Microsoft.Practices.ServiceFactory.ServiceContracts
{
	...
	/// </summary>
	internal partial class ServiceContractDslPackageBase
	{
		...
		protected virtual ExtensionEnablement::CommandExtensionRegistrar CommandExtensionRegistrar
		{
			get 
			{
				if (this.commandExtensionRegistrar == null)
				{
					this.commandExtensionRegistrar = new DesignerExtensionEnablement::ServiceContractDslCommandExtensionRegistrar();
				}
