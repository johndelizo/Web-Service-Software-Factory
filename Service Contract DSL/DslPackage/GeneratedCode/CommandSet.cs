...
namespace Microsoft.Practices.ServiceFactory.ServiceContracts
{
	...
	/// </summary>
	internal partial class ServiceContractDslCommandSet : ServiceContractDslCommandSetBase
	{
		/// <summary>
		/// Constructs a new ServiceContractDslCommandSet.
		/// </summary>
		public ServiceContractDslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ServiceContractDslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ServiceContractDslCommandSetBase.
		/// </summary>
		protected ServiceContractDslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewServiceContractDslExplorerCommand,
				typeof(ServiceContractDslEditorFactory).GUID);
		...
		{
			ServiceContractDslExplorerToolWindow explorer = this.ServiceContractDslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		internal virtual void OnMenuValidateModel(object sender, System.EventArgs e)
		{
			...
			{
				this.CurrentServiceContractDslDocData.ValidationController.Validate(this.CurrentServiceContractDslDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentServiceContractDslDocData != null && this.CurrentServiceContractDslDocData.Store != null)
			{
				...
				this.CurrentServiceContractDslDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected ServiceContractDslDocData CurrentServiceContractDslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ServiceContractDslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ServiceContractDslDocView CurrentServiceContractDslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ServiceContractDslDocView;
			}
		}
		...
		/// </summary>
		protected ServiceContractDslExplorerToolWindow ServiceContractDslExplorerToolWindow
		{
			get
			{
				ServiceContractDslExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ServiceContractDslExplorerToolWindow), true) as ServiceContractDslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ServiceContractDslExplorerToolWindow explorerWindow = this.ServiceContractDslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ServiceContractDslClipboardCommandSet : ServiceContractDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ServiceContractDslClipboardCommandSet.
		/// </summary>
		public ServiceContractDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ServiceContractDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ServiceContractDslClipboardCommandSetBase.
		/// </summary>
		protected ServiceContractDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
