...
using DesignerExtensionEnablement = global::Microsoft.Practices.ServiceFactory.ServiceContracts.ExtensionEnablement;
...
namespace Microsoft.Practices.ServiceFactory.ServiceContracts
{
	...
	/// </summary>
	internal abstract partial class ServiceContractDslDocDataBase
	{
		/// <summary>
		...
		partial void SetValidationExtensionRegistrar(DslValidation::ValidationController validationController)
		{
			if (validationController != null)
			{
				...
				if (compositionService != null)
				{
					...
					validationController.ValidationExtensionRegistrar = new DesignerExtensionEnablement::ServiceContractDslValidationExtensionRegistrar();
