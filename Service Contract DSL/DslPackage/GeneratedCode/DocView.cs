...
namespace Microsoft.Practices.ServiceFactory.ServiceContracts
{
	...
	/// </summary>
	internal partial class ServiceContractDslDocView : ServiceContractDslDocViewBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class ServiceContractDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ServiceContractDslDocView.
		/// </summary>
		protected ServiceContractDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ServiceContractDslDocDataBase docData = this.DocData as ServiceContractDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ServiceContractDslDocViewBase should be an ServiceContractDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ServiceContractDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Microsoft.Practices.ServiceFactory.ServiceContracts.ServiceContractDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
