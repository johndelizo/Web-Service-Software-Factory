...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	/// </remarks>
	public partial class DataContractDslHelpKeywordHelper : DataContractDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DataContractDslHelpKeywordHelper.
		/// </summary>
		protected DataContractDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DataContractDslHelpKeywordHelper.
		/// </summary>
		public static DataContractDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DataContractDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DataContractDslHelpKeywordHelperBase.
		/// </summary>
		protected DataContractDslHelpKeywordHelperBase()
			: base() { }
