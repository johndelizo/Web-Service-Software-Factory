...
{
	/// <summary>
	/// Adapter manager base class (double derived pattern) for the DataContractDsl Designer
	/// </summary>
    public partial class DataContractDslAdapterManagerBase : DslIntegrationShell::VsModelingAdapterManager
	{
		#region Fields
        /// <summary>
        ...
        public DataContractDslAdapterManagerBase()
		{
		}
		#endregion
        ...
        public override global::System.Collections.Generic.IEnumerable<string> GetSupportedLogicalAdapterIds()
		{
            if (supportedAdapterIds == null)
            {
                ...
                supportedAdapterIds = new string[] { DataContractDslAdapter.AdapterId };
            }
	...
	/// <summary>
	/// ModelBus modeling adapter manager for a DataContractDslAdapter model adapter
	/// </summary>
	[Mef::Export(typeof(DslIntegration::ModelBusAdapterManager))]
	[Mef::ExportMetadata(DslIntegration::CompositionAttributes.AdapterIdKey,DataContractDslAdapter.AdapterId)]
	...
	public partial class DataContractDslAdapterManager : DataContractDslAdapterManagerBase
    {
    }
}
