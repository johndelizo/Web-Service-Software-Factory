...
{
    /// <summary>
    /// ModelBus modeling adapter manager for a DataContractDsl  model helper methods
    /// </summary>
	public partial class DataContractDslAdapterManager
    {
        ...
        public static DslIntegration::ModelBusReference CreateDataContractModel(string modelName, DslIntegration::ModelBusReference relativeTo, string relativePath = null)
        {
            ...
            if (adapter != null)
            {
                ...
                return CreateDataContractModel(modelName, filename, relativePath);
            }
            else
                return null;
        }
