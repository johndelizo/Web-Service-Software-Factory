...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	internal abstract class DataContractDslCommandSetBase : DslShell::CommandSet
	{
		...
		internal virtual void OnMenuValidateModel(object sender, System.EventArgs e)
		{
			...
			{
				this.CurrentDataContractDslDocData.ValidationController.Validate(this.CurrentDataContractDslDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DataContractDslClipboardCommandSet : DataContractDslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DataContractDslClipboardCommandSet.
		/// </summary>
		public DataContractDslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DataContractDslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DataContractDslClipboardCommandSetBase.
		/// </summary>
		protected DataContractDslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
