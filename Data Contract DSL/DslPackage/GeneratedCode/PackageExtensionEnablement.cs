...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	/// </summary>
	internal partial class DataContractDslPackageBase
	{
		...
		protected virtual ExtensionEnablement::CommandExtensionRegistrar CommandExtensionRegistrar
		{
			get 
			{
				if (this.commandExtensionRegistrar == null)
				{
					this.commandExtensionRegistrar = new DesignerExtensionEnablement::DataContractDslCommandExtensionRegistrar();
				}
