...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	/// </summary>
	internal partial class DataContractDslDocView : DataContractDslDocViewBase
	{
		/// <summary>
		/// Constructs a new DataContractDslDocView.
		/// </summary>
		public DataContractDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DataContractDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DataContractDslDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			DataContractDslDocDataBase docData = this.DocData as DataContractDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DataContractDslDocViewBase should be an DataContractDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DataContractDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
