...
using DesignerExtensionEnablement = global::Microsoft.Practices.ServiceFactory.DataContracts.ExtensionEnablement;
...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	/// </summary>
	internal abstract partial class DataContractDslDocDataBase
	{
		/// <summary>
		...
		partial void SetValidationExtensionRegistrar(DslValidation::ValidationController validationController)
		{
			if (validationController != null)
			{
				...
				if (compositionService != null)
				{
					...
					validationController.ValidationExtensionRegistrar = new DesignerExtensionEnablement::DataContractDslValidationExtensionRegistrar();
