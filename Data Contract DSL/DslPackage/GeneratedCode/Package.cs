...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	[VSShell::ProvideStaticToolboxGroup("@Data Contract ToolsToolboxTab;Microsoft.Practices.ServiceFactory.DataContracts.Dsl.dll", "Microsoft.Practices.ServiceFactory.DataContracts.Data Contract ToolsToolboxTab")]
	[VSShell::ProvideStaticToolboxItem("Microsoft.Practices.ServiceFactory.DataContracts.Data Contract ToolsToolboxTab",
					"@DataContractToolToolboxItem;Microsoft.Practices.ServiceFactory.DataContracts.Dsl.dll", 
					"Microsoft.Practices.ServiceFactory.DataContracts.DataContractToolToolboxItem", 
	...
	[DslShell::ProvideXmlEditorChooserBlockSxSWithXmlEditor(@"DataContractDsl", typeof(DataContractDslEditorFactory))]

	internal abstract partial class DataContractDslPackageBase : DslShell::ModelingPackage
	{
		protected global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslToolboxHelper toolboxHelper;	
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new DataContractDslEditorFactory(this));
			
			// Initialize the toolbox helper
			toolboxHelper = new global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslToolboxHelper(this);

			// Create the command set that handles menu commands provided by this package.
			DataContractDslCommandSet commandSet = new DataContractDslCommandSet(this);
			commandSet.Initialize();
			
			// Create the command set that handles cut/copy/paste commands provided by this package.
			DataContractDslClipboardCommandSet clipboardCommandSet = new DataContractDslClipboardCommandSet(this);
			clipboardCommandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(DataContractDslExplorerToolWindow));
...
namespace Microsoft.Practices.ServiceFactory.DataContracts
{
	...
	/// </summary>
	[VSShell::ProvideMenuResource("1000.ctmenu", 20)]
	[VSShell::ProvideToolboxItems(1)]
	[global::Microsoft.VisualStudio.TextTemplating.VSHost.ProvideDirectiveProcessor(typeof(global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslDirectiveProcessor), global::Microsoft.Practices.ServiceFactory.DataContracts.DataContractDslDirectiveProcessor.DataContractDslDirectiveProcessorName, "A directive processor that provides access to DataContractDsl files")]
	[global::System.Runtime.InteropServices.Guid(Constants.DataContractDslPackageId)]
	internal sealed partial class DataContractDslPackage : DataContractDslPackageBase
	{
	}
}
